...
int zte_lcd_check_status_tianma_hx8394d_720p_video(struct mdss_dsi_ctrl_pdata *pdata)
{
    ...
    u8 reg_buf_read_2[3] = {0x00, 0x00, 0x00};
    u8 reg_buf_read_3[2] = {0x00, 0x00};
    ...
    u8 reg_buf_key_2 [3] = {0x80, 0x73, 0x06};  
    u8 reg_buf_key_3 [3] = {0x05, 0x16};  

    static u8 check_count = 1;
    check_count = (check_count > 3) ? 1 : check_count;
    ...
    switch(check_count++)
    {
        ...
        case 3:
        {
            check_result = zte_lcd_reg_check(pdata, reg_addr_3, reg_buf_read_3, reg_buf_key_3, reg_data_len_3);
            if (false==check_result)
            {
                goto zte_lcd_check_status_tianma_hx8394d_720p_video_error;
            }
