...
static int upgrade_firmware_from_class(struct cyttsp4_device *ttsp)
{
	...
	retval = request_firmware_nowait(THIS_MODULE, FW_ACTION_NOHOTPLUG, "cyttsp4_loader.main_ttsp_core",
...
static DEVICE_ATTR(fw_upgrade_flag, 0444, cyttsp4_fw_upgrade_flag_show, NULL);
